...
public class ActionTypeControllerTest {
    ...
    public void actionTypeListTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/pad/actionType"))
    ...
    public void actionTypeDetailTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/pad/actionType/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void actionTypeSaveTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/pad/actionType")
    ...
    public void actionTypeUpdateTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put("/pad/actionType")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content("{\n" +
                        "    \"actionTypeId\": 3,\n" +
                        "    \"actionTypeName\": \"胸部\",\n" +
    ...
    public void actionTypeDeleteTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/pad/actionType/2"))
                .andExpect(MockMvcResultMatchers.status().isNoContent())
                .andDo(MockMvcResultHandlers.print());
    }
}
