...
public class ActionControllerTest {
    ...
    public void actionListTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/pad/action"))
    ...
    public void actionDetailTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/pad/action/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void actionSaveTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/pad/action")
    ...
    public void actionUpdateTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put("/pad/action")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content("{\n" +
                        "    \"actionId\": 76,\n" +
                        "    \"actionName\": \"测试9999\",\n" +
    ...
    public void actionDeleteTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/pad/action/9"))
                .andExpect(MockMvcResultMatchers.status().isNoContent())
                .andDo(MockMvcResultHandlers.print());
    }
}
