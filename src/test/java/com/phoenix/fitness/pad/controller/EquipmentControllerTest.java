...
public class EquipmentControllerTest {
    ...
    public void equipmentListTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/pad/equipment"))
    ...
    public void equipmentDetailTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/pad/equipment/1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void equipmentSaveTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/pad/equipment")
    ...
    public void equipmentUpdateTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put("/pad/equipment")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content("{\n" +
                         "    \"equipmentId\": 9,\n" +
                         "    \"equipmentName\": \"椭圆机\",\n" +
    ...
    public void equipmentDeleteTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/pad/equipment/9"))
                .andExpect(MockMvcResultMatchers.status().isNoContent())
                .andDo(MockMvcResultHandlers.print());
    }
}
