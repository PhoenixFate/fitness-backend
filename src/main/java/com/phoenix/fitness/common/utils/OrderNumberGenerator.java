...
public class OrderNumberGenerator {
     ...
     * @return
     */
    public static String getLongOrderNumber(String lock) {
     ...
     * @return
     */
    public static String getShortOrderNumber(String lock) {
        if (Objects.isNull(threadLocal.get())) {
            lock = Objects.isNull(lock) ? UUID.randomUUID().toString() : lock;
        ...
        for (int i = 0; i < 1000; i++) {
            Callable<String> callable = new Callable<String>() {
                ...
                public String call() throws Exception {
                    ...
                    //return getShortOrderNumber(null);
                    return getLongOrderNumber(null);
                }
            };
