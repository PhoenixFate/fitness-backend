...
public class AdminDietPlanController {
    ...
    public ResponseEntity<R> list(@RequestParam Map<String, Object> params) {
        PageUtils page = dietPlanService.queryPage(params, new UserEntity());
    ...
    @PostMapping()
    @ApiOperation("新增饮食计划")
    public ResponseEntity<R> save(@RequestBody @Valid DietPlanWithItemsDto dietPlan) {
